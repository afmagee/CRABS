...
lambda <- function(t) ifelse( t > 3, 0.1, 0.4)
mu     <- function(t) ifelse( t > 2, 0.05, 0.2)
samples <- sample.congruence.class(func_spec0=lambda, func_ext0=mu, max.t=5, max.rate=2, num.epochs=100, num.samples=1000)
p      = plot.congruence.class(func_spec0=lambda, func_ext0=mu, max.t=5, sample.grid=samples )
print(p)
