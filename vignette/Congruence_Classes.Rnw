...
<<TESS-analysis, child = "tess_analysis.Rnw">>=
@

<<treepar-analysis, child = "treepar.Rnw">>=
@

<<RevBayes-analysis, child = "RevBayes.Rnw">>=
@
...
ggsave(p,file="RnwFigs/Primates_HSMRF_ACDC_extinction_HSMRF.pdf", width=160,height=80, units = "mm")
@

\begin{figure}[h!]
\centering
\includegraphics[width=0.98\textwidth,angle=0]{RnwFigs/Primates_HSMRF_ACDC_extinction_HSMRF.pdf}
...
ggsave(p,file="RnwFigs/Primates_HSMRF_ACDC_extinction_exponential.pdf", width=160,height=80, units = "mm")
@

\begin{figure}[h!]
\centering
\includegraphics[width=0.98\textwidth,angle=0]{RnwFigs/Primates_HSMRF_ACDC_extinction_exponential.pdf}
\caption{Congruence class assuming linearly changing extinction rates.}
\label{fig:extinction_linear_spaghetti}
\end{figure}
...
ggsave(p,file="RnwFigs/Primates_HSMRF_ACDC_extinction_linear.pdf", width=160,height=80, units = "mm")
@

\begin{figure}[h!]
\centering
\includegraphics[width=0.98\textwidth,angle=0]{RnwFigs/Primates_HSMRF_ACDC_extinction_linear.pdf}
\caption{Congruence class assuming linearly changing extinction rates.}
\label{fig:extinction_linear_spaghetti}
\end{figure}
...
ggsave(p,file="RnwFigs/Primates_HSMRF_ACDC_extinction_episodic.pdf", width=160,height=80, units = "mm")
@

\begin{figure}[h!]
\centering
\includegraphics[width=0.98\textwidth,angle=0]{RnwFigs/Primates_HSMRF_ACDC_extinction_episodic.pdf}
...
ggsave(p,file="RnwFigs/Primates_HSMRF_ACDC_extinction_uniform.pdf", width=160,height=80, units = "mm")
@

\begin{figure}[h!]
\centering
\includegraphics[width=0.98\textwidth,angle=0]{RnwFigs/Primates_HSMRF_ACDC_extinction_uniform.pdf}
