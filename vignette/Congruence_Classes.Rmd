...
Summarising alternative models is somewhat less established.
...
A change in rate over time is mathematically represented by the slope of the rate function; a large slope means more/steeper change in less time, while a low value for the slope corresponds to rather constant rates.
Therefore, we summarise the models by computing the slope of the rate function.
...
We also provide an example for fitting birth-death models in TreePar (Section \@ref(treepar)) and TESS (Section \@ref(tess)). 
