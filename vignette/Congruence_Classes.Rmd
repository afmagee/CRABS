---
title: "CRABS: Congruent Rate Analysis in Birth-death Scenarios"
date: '`r Sys.Date()`'
author: 
  - Sebastian Höhna
  - Bjørn T. Kopperud
...
This is a vignette, or long-form documentation, accompanying the R-package CRABS: Congruent Rate Analysis in Birth-death Scenarios.
...
For `sample.basic.models`, we have a separate section explaining the most important flags and use cases because `sample.basic.models` might represent a more complex but important function of `CRABS`.
