...
The argument \code{fc.mean} dictates the average amount of change from first to last rate as a fold change.
...
All rate curves are sampled by rejection sampling to guarantee that the rates are all between \code{minimum.rate} and \code{maximum.rate}.
...
If you have not run a \RevBayes analysis and wish to explore functionality of the package, we have provided a thinned output file, accessible with \code{data("HSMRFBDP_primates")}.
...
curve( lambda, xlim=c(max_t, 0), lwd=2, lty=1, col="blue",
       ...
       cex.main=1.5, cex.lab=1.5 )
curve( mu, add=TRUE, lwd=2, lty=1, col="red" )
legend("bottomright",legend=c("speciation","extinction"),
       col=c("blue","red"), lty=c(1,1), cex=1.2)
@
...
As in our previous example, we want to explore linear extinction rates but this time we choose linear \emph{decreasing} extinction rates.
...
ACDC.plot.congruence.class.spaghetti(func_spec0=lambda,
                                     ...
                                     max.curves=100 )
@
<<congruence-class-extinction-lognormal-spaghetti, chache=TRUE, results='hide', include=FALSE>>=
pdf(file="RnwFigs/Primates_HSMRF_ACDC_extinction_lognormal_speghetti.pdf",width=5,height=10)
ACDC.plot.congruence.class.spaghetti(func_spec0=lambda,
                                     func_ext0=mu,
                                     max.t=max_t,
                                     sample.grid=samples,
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.48\textwidth,angle=0]{RnwFigs/Primates_HSMRF_ACDC_extinction_lognormal.pdf}
\includegraphics[width=0.48\textwidth,angle=0]{RnwFigs/Primates_HSMRF_ACDC_extinction_lognormal_speghetti.pdf}
\caption{Congruence class assuming independent and lognormal distributed extinction rates.}
\label{fig:extinction_lognormal_spaghetti}
\end{figure}
...
ACDC.plot.congruence.class.spaghetti(func_spec0=lambda,
                                     ...
                                     max.curves=100 )
@
<<congruence-class-extinction-GMRF-spaghetti, chache=TRUE, results='hide', include=FALSE>>=
pdf(file="RnwFigs/Primates_HSMRF_ACDC_extinction_GMRF_speghetti.pdf",width=5,height=10)
ACDC.plot.congruence.class.spaghetti(func_spec0=lambda,
                                     func_ext0=mu,
                                     max.t=max_t,
                                     sample.grid=samples,
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.48\textwidth,angle=0]{RnwFigs/Primates_HSMRF_ACDC_extinction_GMRF.pdf}
\includegraphics[width=0.48\textwidth,angle=0]{RnwFigs/Primates_HSMRF_ACDC_extinction_GMRF_speghetti.pdf}
\caption{Congruence class assuming GMRF distributed extinction rates.}
\label{fig:extinction_GMRF_spaghetti}
\end{figure}
...
ACDC.plot.congruence.class.spaghetti(func_spec0=lambda,
                                     ...
                                     max.curves=100 )
@
<<congruence-class-extinction-GMRF_trend-spaghetti, chache=TRUE, results='hide', include=FALSE>>=
pdf(file="RnwFigs/Primates_HSMRF_ACDC_extinction_GMRF_trend_speghetti.pdf",width=5,height=10)
ACDC.plot.congruence.class.spaghetti(func_spec0=lambda,
                                     func_ext0=mu,
                                     max.t=max_t,
                                     sample.grid=samples,
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.48\textwidth,angle=0]{RnwFigs/Primates_HSMRF_ACDC_extinction_GMRF_trend.pdf}
\includegraphics[width=0.48\textwidth,angle=0]{RnwFigs/Primates_HSMRF_ACDC_extinction_GMRF_trend_speghetti.pdf}
\caption{Congruence class assuming GMRF with trend distributed extinction rates.}
\label{fig:extinction_GMRF_trend_spaghetti}
\end{figure}
